...
<div style="width: 700px; margin: auto; font-family: Arial, sans-serif; line-height: 1.5;">
    ...
    <div style="width: 100%; text-align: center; margin-bottom: 25px;">
        ...
        <h1 style="margin: 10px 0 0 0; font-size: 30px; font-weight: bold; color: #222;">{{ $data['name'] ?? 'Your Name' }}</h1>
    ...
    <!-- References -->
    @if(!empty($data['reference']) && count($data['reference']) > 0)
    ...
    <!-- Certificates -->
    @if(!empty($data['certificate']) && count($data['certificate']) > 0)
